...
import { View, Image, ActivityIndicator, ToastAndroid, LogBox, Text } from 'react-native';
    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: "#F44336" }}>
                ...
                <Text style={{ textAlign: "center", fontSize: 40, color: "white", marginTop: 20 }}>{this.props.route.params.width + "x" + this.props.route.params.height}</Text>
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                    <UniversalButton text={"Share"} onClick={this.sharePhoto} bgColor={"#FF9800"} color={"#FFFFFF"} />
                    <UniversalButton text={"Delete"} onClick={this.deletePhoto} bgColor={"#FF9800"} color={"#FFFFFF"} />
                </View>
